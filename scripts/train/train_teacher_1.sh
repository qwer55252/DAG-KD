...
CUDA_VISIBLE_DEVICES=2 python3 train_teacher.py \
  ...
  --resume_ckpt_path /workspace/DAG-KD/outputs/train_ver2/train_ver2_teacher_1/checkpoints_teacher/teacher-epoch=99-step=89200.ckpt